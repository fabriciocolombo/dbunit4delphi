...
uses BaseTestCase, DatabaseConnection, DatabaseConnectionFactory, DB,
  DatabaseConnectionType, DataSet, DatabaseConfig;

type
  TTesteMetadata = class(TBaseTestCase)
  private
...
begin
  ...
  try
    ...
    CheckEqualsAnsiString('Dummy', vField.FieldName, 'FieldName');
